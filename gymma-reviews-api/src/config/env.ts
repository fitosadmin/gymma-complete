...
const schema = z.object({
  ...
  // Gymma Review System
  GYMMA_PLATFORM_SALT: z.string().min(16, 'GYMMA_PLATFORM_SALT is required and must be at least 16 chars'),
  GYMMA_BAYESIAN_M: z.coerce.number().default(30),
  GYMMA_BAYESIAN_C: z.coerce.number().default(50),
  GYMMA_MIN_REVIEWS_PUBLIC: z.coerce.number().default(10),
  GYMMA_TIER_STABILIZATION_DAYS: z.coerce.number().default(14),
